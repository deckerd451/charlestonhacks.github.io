...
function showAuthUI(needsLogin) {
  // hide or show entire container (title/desc/auth) vs canvas & controls
  document.getElementById('container').style.display      = needsLogin ? ''   : 'none';
